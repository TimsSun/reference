...
</script><a href="https://github.com/jaywcjlove/reference" class="" target="__blank"><svg viewBox="0 0 16 16" fill="currentColor" height="1em" width="1em"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a></div></div></nav><div class="wrap max-container"><header class="wrap-header h1wrap"><h1 id=""><a aria-hidden="true" tabindex="-1" href="#"><span class="icon icon-link"></span></a><a href="https://unifiedjs.com"><img src="https://raw.githubusercontent.com/unifiedjs/unified/93862e5/logo.svg?sanitize=true" alt="unified"></a></h1><div class="wrap-body">
...
formats.</p>
</div></header><div class="h1wrap-body"><div class="wrap"><div class="wrap-header h2wrap"><h2 id="intro"><a aria-hidden="true" tabindex="-1" href="#intro"><span class="icon icon-link"></span></a>Intro</h2><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="contents"><a aria-hidden="true" tabindex="-1" href="#contents"><span class="icon icon-link"></span></a>Contents</h2><div class="wrap-body">
<ul>
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="description"><a aria-hidden="true" tabindex="-1" href="#description"><span class="icon icon-link"></span></a>Description</h2><div class="wrap-body">
<p><strong>unified</strong> is an interface for processing text using syntax trees.
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="processors"><a aria-hidden="true" tabindex="-1" href="#processors"><span class="icon icon-link"></span></a>Processors</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="syntax-trees"><a aria-hidden="true" tabindex="-1" href="#syntax-trees"><span class="icon icon-link"></span></a>Syntax trees</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="list-of-processors"><a aria-hidden="true" tabindex="-1" href="#list-of-processors"><span class="icon icon-link"></span></a>List of processors</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="list-of-plugins"><a aria-hidden="true" tabindex="-1" href="#list-of-plugins"><span class="icon icon-link"></span></a>List of plugins</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="file"><a aria-hidden="true" tabindex="-1" href="#file"><span class="icon icon-link"></span></a>File</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="configuration"><a aria-hidden="true" tabindex="-1" href="#configuration"><span class="icon icon-link"></span></a>Configuration</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="integrations"><a aria-hidden="true" tabindex="-1" href="#integrations"><span class="icon icon-link"></span></a>Integrations</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="programming-interface"><a aria-hidden="true" tabindex="-1" href="#programming-interface"><span class="icon icon-link"></span></a>Programming interface</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="processing-between-syntaxes"><a aria-hidden="true" tabindex="-1" href="#processing-between-syntaxes"><span class="icon icon-link"></span></a>Processing between syntaxes</h6><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="api"><a aria-hidden="true" tabindex="-1" href="#api"><span class="icon icon-link"></span></a>API</h2><div class="wrap-body">
<p>This package exports the following identifiers: <code>unified</code>.
There is no default export.</p>
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processor"><a aria-hidden="true" tabindex="-1" href="#processor"><span class="icon icon-link"></span></a><code>processor()</code></h3><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processoruseplugin-options"><a aria-hidden="true" tabindex="-1" href="#processoruseplugin-options"><span class="icon icon-link"></span></a><code>processor.use(plugin[, options])</code></h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note"><a aria-hidden="true" tabindex="-1" href="#note"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processorparsefile"><a aria-hidden="true" tabindex="-1" href="#processorparsefile"><span class="icon icon-link"></span></a><code>processor.parse(file)</code></h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-1"><a aria-hidden="true" tabindex="-1" href="#note-1"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
...
</div></div><div class="h6wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="processorparser"><a aria-hidden="true" tabindex="-1" href="#processorparser"><span class="icon icon-link"></span></a><code>processor.Parser</code></h4><div class="wrap-body">
...
</div></div></div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processorstringifynode-file"><a aria-hidden="true" tabindex="-1" href="#processorstringifynode-file"><span class="icon icon-link"></span></a><code>processor.stringify(node[, file])</code></h3><div class="wrap-body">
...
tree</em></a></p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-2"><a aria-hidden="true" tabindex="-1" href="#note-2"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
...
</div></div><div class="h6wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="processorcompiler"><a aria-hidden="true" tabindex="-1" href="#processorcompiler"><span class="icon icon-link"></span></a><code>processor.Compiler</code></h4><div class="wrap-body">
...
</div></div></div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processorrunnode-file-done"><a aria-hidden="true" tabindex="-1" href="#processorrunnode-file-done"><span class="icon icon-link"></span></a><code>processor.run(node[, file][, done])</code></h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-3"><a aria-hidden="true" tabindex="-1" href="#note-3"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
...
</div></div><div class="h6wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="function-doneerr-node-file"><a aria-hidden="true" tabindex="-1" href="#function-doneerr-node-file"><span class="icon icon-link"></span></a><code>function done(err[, node, file])</code></h4><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-4"><a aria-hidden="true" tabindex="-1" href="#parameters-4"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processorrunsyncnode-file"><a aria-hidden="true" tabindex="-1" href="#processorrunsyncnode-file"><span class="icon icon-link"></span></a><code>processor.runSync(node[, file])</code></h3><div class="wrap-body">
<p>Run <a href="#function-transformernode-file-next"><em>transformers</em></a> on a <a href="#syntax-trees"><em>syntax tree</em></a>.</p>
<p>An error is thrown if asynchronous <a href="#plugin"><em>plugin</em></a>s are configured.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-5"><a aria-hidden="true" tabindex="-1" href="#parameters-5"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
<li><code>node</code> (<a href="https://github.com/syntax-tree/unist#node"><code>Node</code></a>) — <a href="#syntax-trees"><em>Syntax tree</em></a> to run on</li>
<li><code>file</code> (<a href="https://github.com/vfile/vfile"><code>VFile</code></a>, optional) — <a href="#file"><em>File</em></a>, any value accepted by
<code>vfile()</code></li>
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-4"><a aria-hidden="true" tabindex="-1" href="#note-4"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processorprocessfile-done"><a aria-hidden="true" tabindex="-1" href="#processorprocessfile-done"><span class="icon icon-link"></span></a><code>processor.process(file[, done])</code></h3><div class="wrap-body">
<p><a href="#description"><em>Process</em></a> the given <a href="#file"><em>file</em></a> as configured on the
processor.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-6"><a aria-hidden="true" tabindex="-1" href="#parameters-6"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
<li><code>file</code> (<a href="https://github.com/vfile/vfile"><code>VFile</code></a>) — <a href="#file"><em>File</em></a>, any value accepted by <code>vfile()</code></li>
<li><code>done</code> (<a href="#function-doneerr-file"><code>Function</code></a>, optional) — Callback</li>
</ul>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="returns-6"><a aria-hidden="true" tabindex="-1" href="#returns-6"><span class="icon icon-link"></span></a>Returns</h6><div class="wrap-body">
<p><a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise"><code>Promise</code></a> if <code>done</code> is not given.
The returned promise is rejected with a fatal error, or resolved with the
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-5"><a aria-hidden="true" tabindex="-1" href="#note-5"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="example-5"><a aria-hidden="true" tabindex="-1" href="#example-5"><span class="icon icon-link"></span></a>Example</h6><div class="wrap-body">
...
</div></div><div class="h6wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="function-doneerr-file"><a aria-hidden="true" tabindex="-1" href="#function-doneerr-file"><span class="icon icon-link"></span></a><code>function done(err, file)</code></h4><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-7"><a aria-hidden="true" tabindex="-1" href="#parameters-7"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
<li><code>err</code> (<code>Error</code>, optional) — Fatal error</li>
<li><code>file</code> (<a href="https://github.com/vfile/vfile"><code>VFile</code></a>) — Processed <a href="#file"><em>file</em></a></li>
</ul>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="example-6"><a aria-hidden="true" tabindex="-1" href="#example-6"><span class="icon icon-link"></span></a>Example</h6><div class="wrap-body">
<p>The below example shows how <code>process</code> can be used to process a file, whether
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processorprocesssyncfilevalue"><a aria-hidden="true" tabindex="-1" href="#processorprocesssyncfilevalue"><span class="icon icon-link"></span></a><code>processor.processSync(file|value)</code></h3><div class="wrap-body">
<p><a href="#description"><em>Process</em></a> the given <a href="#file"><em>file</em></a> as configured on the
processor.</p>
<p>An error is thrown if asynchronous <a href="#plugin"><em>plugin</em></a>s are configured.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-8"><a aria-hidden="true" tabindex="-1" href="#parameters-8"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
<li><code>file</code> (<a href="https://github.com/vfile/vfile"><code>VFile</code></a>) — <a href="#file"><em>File</em></a>, any value accepted by <code>vfile()</code></li>
</ul>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="returns-7"><a aria-hidden="true" tabindex="-1" href="#returns-7"><span class="icon icon-link"></span></a>Returns</h6><div class="wrap-body">
<p>(<a href="https://github.com/vfile/vfile"><code>VFile</code></a>) — Processed <a href="#file"><em>file</em></a></p>
<p>The parsed, transformed, and compiled value is exposed on
<a href="https://github.com/vfile/vfile#vfilevalue"><code>file.value</code></a> or <code>file.result</code> (see notes).</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-6"><a aria-hidden="true" tabindex="-1" href="#note-6"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
...
<code>file.value</code>.
Otherwise, the result is available at <code>file.result</code>.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="example-7"><a aria-hidden="true" tabindex="-1" href="#example-7"><span class="icon icon-link"></span></a>Example</h6><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processordatakey-value"><a aria-hidden="true" tabindex="-1" href="#processordatakey-value"><span class="icon icon-link"></span></a><code>processor.data([key[, value]])</code></h3><div class="wrap-body">
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="signatures-1"><a aria-hidden="true" tabindex="-1" href="#signatures-1"><span class="icon icon-link"></span></a>Signatures</h6><div class="wrap-body">
<ul>
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-9"><a aria-hidden="true" tabindex="-1" href="#parameters-9"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="returns-8"><a aria-hidden="true" tabindex="-1" href="#returns-8"><span class="icon icon-link"></span></a>Returns</h6><div class="wrap-body">
<ul>
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-7"><a aria-hidden="true" tabindex="-1" href="#note-7"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
<p>Setting information cannot occur on <a href="#processorfreeze"><em>frozen</em></a> processors.
Call the processor first to create a new unfrozen processor.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="example-8"><a aria-hidden="true" tabindex="-1" href="#example-8"><span class="icon icon-link"></span></a>Example</h6><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="processorfreeze"><a aria-hidden="true" tabindex="-1" href="#processorfreeze"><span class="icon icon-link"></span></a><code>processor.freeze()</code></h3><div class="wrap-body">
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="returns-9"><a aria-hidden="true" tabindex="-1" href="#returns-9"><span class="icon icon-link"></span></a>Returns</h6><div class="wrap-body">
<p><code>processor</code> — The processor that <code>freeze</code> was called on.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="example-9"><a aria-hidden="true" tabindex="-1" href="#example-9"><span class="icon icon-link"></span></a>Example</h6><div class="wrap-body">
...
</div></div></div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="plugin"><a aria-hidden="true" tabindex="-1" href="#plugin"><span class="icon icon-link"></span></a><code>Plugin</code></h2><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="example-10"><a aria-hidden="true" tabindex="-1" href="#example-10"><span class="icon icon-link"></span></a>Example</h6><div class="wrap-body">
...
</div></div><div class="h6wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="function-attacheroptions"><a aria-hidden="true" tabindex="-1" href="#function-attacheroptions"><span class="icon icon-link"></span></a><code>function attacher([options])</code></h3><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="context"><a aria-hidden="true" tabindex="-1" href="#context"><span class="icon icon-link"></span></a>Context</h6><div class="wrap-body">
<p>The context object (<code>this</code>) is set to the processor the attacher is applied on.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-10"><a aria-hidden="true" tabindex="-1" href="#parameters-10"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
<li><code>options</code> (<code>*</code>, optional) — Configuration</li>
</ul>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="returns-10"><a aria-hidden="true" tabindex="-1" href="#returns-10"><span class="icon icon-link"></span></a>Returns</h6><div class="wrap-body">
<p><a href="#function-transformernode-file-next"><code>transformer</code></a> — Optional.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="note-8"><a aria-hidden="true" tabindex="-1" href="#note-8"><span class="icon icon-link"></span></a>Note</h6><div class="wrap-body">
<p>Attachers are called when the processor is <a href="#processorfreeze"><em>frozen</em></a>, not when they are
applied.</p>
</div></div><div class="h6wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="function-transformernode-file-next"><a aria-hidden="true" tabindex="-1" href="#function-transformernode-file-next"><span class="icon icon-link"></span></a><code>function transformer(node, file[, next])</code></h3><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-11"><a aria-hidden="true" tabindex="-1" href="#parameters-11"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="returns-11"><a aria-hidden="true" tabindex="-1" href="#returns-11"><span class="icon icon-link"></span></a>Returns</h6><div class="wrap-body">
<ul>
...
</div></div><div class="h6wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="function-nexterr-tree-file"><a aria-hidden="true" tabindex="-1" href="#function-nexterr-tree-file"><span class="icon icon-link"></span></a><code>function next(err[, tree[, file]])</code></h4><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="parameters-12"><a aria-hidden="true" tabindex="-1" href="#parameters-12"><span class="icon icon-link"></span></a>Parameters</h6><div class="wrap-body">
<ul>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="preset"><a aria-hidden="true" tabindex="-1" href="#preset"><span class="icon icon-link"></span></a><code>Preset</code></h2><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="example-11"><a aria-hidden="true" tabindex="-1" href="#example-11"><span class="icon icon-link"></span></a>Example</h6><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="contribute"><a aria-hidden="true" tabindex="-1" href="#contribute"><span class="icon icon-link"></span></a>Contribute</h2><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="acknowledgments"><a aria-hidden="true" tabindex="-1" href="#acknowledgments"><span class="icon icon-link"></span></a>Acknowledgments</h2><div class="wrap-body">
