...
<span class="title">Quick Reference</span></a><div class="menu"><a href="https://github.com/jaywcjlove/reference/blob/main/node_modules/remark-gfm\readme.md" class="" target="__blank"><svg viewBox="0 0 36 36" fill="currentColor" height="1em" width="1em"><path d="m33 6.4-3.7-3.7a1.71 1.71 0 0 0-2.36 0L23.65 6H6a2 2 0 0 0-2 2v22a2 2 0 0 0 2 2h22a2 2 0 0 0 2-2V11.76l3-3a1.67 1.67 0 0 0 0-2.36ZM18.83 20.13l-4.19.93 1-4.15 9.55-9.57 3.23 3.23ZM29.5 9.43 26.27 6.2l1.85-1.85 3.23 3.23Z"></path><path fill="none" d="M0 0h36v36H0z"></path></svg><span>编辑</span></a><button id="darkMode" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="light" height="1em" width="1em">
...
</script><a href="https://github.com/jaywcjlove/reference" class="" target="__blank"><svg viewBox="0 0 16 16" fill="currentColor" height="1em" width="1em"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a></div></div></nav><div class="wrap max-container"><header class="wrap-header h1wrap"><h1 id="remark-gfm"><a aria-hidden="true" tabindex="-1" href="#remark-gfm"><span class="icon icon-link"></span></a>remark-gfm</h1><div class="wrap-body">
<p><a href="https://github.com/remarkjs/remark-gfm/actions"><img src="https://github.com/remarkjs/remark-gfm/workflows/main/badge.svg" alt="Build"></a>
<a href="https://codecov.io/github/remarkjs/remark-gfm"><img src="https://img.shields.io/codecov/c/github/remarkjs/remark-gfm.svg" alt="Coverage"></a>
<a href="https://www.npmjs.com/package/remark-gfm"><img src="https://img.shields.io/npm/dm/remark-gfm.svg" alt="Downloads"></a>
<a href="https://bundlephobia.com/result?p=remark-gfm"><img src="https://img.shields.io/bundlephobia/minzip/remark-gfm.svg" alt="Size"></a>
...
<p><strong><a href="https://github.com/remarkjs/remark">remark</a></strong> plugin to support <a href="https://github.github.com/gfm/">GFM</a> (autolink literals, footnotes,
...
<li><a href="#api">API</a>
<ul>
<li><a href="#unifieduseremarkgfm-options"><code>unified().use(remarkGfm[, options])</code></a></li>
</ul>
</li>
<li><a href="#examples">Examples</a>
<ul>
<li><a href="#example-singletilde">Example: <code>singleTilde</code></a></li>
...
<p>This package is a <a href="https://github.com/unifiedjs/unified">unified</a> (<a href="https://github.com/remarkjs/remark">remark</a>) plugin to enable the extensions to
markdown that GitHub adds: autolink literals (<code>www.x.com</code>), footnotes (<code>[^1]</code>),
strikethrough (<code>~~stuff~~</code>), tables (<code>| cell |…</code>), and tasklists (<code>* [x]</code>).
You can use this plugin to add support for parsing and serializing them.
These extensions by GitHub to CommonMark are called <a href="https://github.github.com/gfm/">GFM</a> (GitHub Flavored
Markdown).</p>
...
This is a remark plugin that transforms mdast.</p>
...
does in files in a repo, Gists, and several other places.
Users frequently believe that some of these extensions, specifically autolink
literals and tables, are part of normal markdown, so using <code>remark-gfm</code> will
help match your implementation to their understanding of markdown.
There are several edge cases where GitHub’s implementation works in unexpected
ways or even different than described in their spec, so <em>writing</em> in GFM is not
always the best choice.</p>
<p>This plugin does not handle how markdown is turned to HTML.
That’s done by <a href="https://github.com/remarkjs/remark-rehype"><code>remark-rehype</code></a>.
If your content is not in English and uses footnotes, you should configure that
plugin.
When generating HTML, you might also want to enable <a href="https://github.com/rehypejs/rehype-slug"><code>rehype-slug</code></a>
to add <code>id</code>s on headings.</p>
<p>A different plugin, <a href="https://github.com/remarkjs/remark-frontmatter"><code>remark-frontmatter</code></a>, adds support for
frontmatter.
GitHub supports YAML frontmatter for files in repos and Gists but they don’t
treat it as part of GFM.</p>
<p>Another plugin, <a href="https://github.com/remarkjs/remark-github"><code>remark-github</code></a>, adds support for how markdown
works in relation to a certain GitHub repo in comments, issues, PRs, and
releases, by linking references to commits, issues, and users.</p>
<p>Yet another plugin, <a href="https://github.com/remarkjs/remark-breaks"><code>remark-breaks</code></a>, turns soft line endings
(enters) into hard breaks (<code>&#x3C;br></code>s).
GitHub does this in a few places (comments, issues, PRs, and releases).</p>
...
<pre class="language-sh"><code class="language-sh code-highlight"><span class="code-line"><span class="token function">npm</span> <span class="token function">install</span> remark-gfm
</span></code></pre>
<p>In Deno with <a href="https://www.skypack.dev">Skypack</a>:</p>
<pre class="language-js"><code class="language-js code-highlight"><span class="code-line"><span class="token keyword module">import</span> <span class="token imports">remarkGfm</span> <span class="token keyword module">from</span> <span class="token string">'https://cdn.skypack.dev/remark-gfm@3?dts'</span>
</span></code></pre>
...
</span></span></span><span class="code-line"><span class="token script"><span class="token language-javascript">  <span class="token keyword module">import</span> <span class="token imports">remarkGfm</span> <span class="token keyword module">from</span> <span class="token string">'https://cdn.skypack.dev/remark-gfm@3?min'</span>
...
</span><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>p</span><span class="token punctuation">></span></span>A note<span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>sup</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>#user-content-fn-1<span class="token punctuation">"</span></span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>user-content-fnref-1<span class="token punctuation">"</span></span> <span class="token attr-name">data-footnote-ref</span> <span class="token attr-name">aria-describedby</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>footnote-label<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>1<span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>a</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>sup</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>p</span><span class="token punctuation">></span></span>
...
</span><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>ul</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>contains-task-list<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
</span><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>li</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>task-list-item<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>input</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>checkbox<span class="token punctuation">"</span></span> <span class="token attr-name">disabled</span><span class="token punctuation">></span></span> to do<span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>li</span><span class="token punctuation">></span></span>
</span><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>li</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>task-list-item<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>input</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>checkbox<span class="token punctuation">"</span></span> <span class="token attr-name">checked</span> <span class="token attr-name">disabled</span><span class="token punctuation">></span></span> done<span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>li</span><span class="token punctuation">></span></span>
...
The default export is <code>remarkGfm</code>.</p>
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="unifieduseremarkgfm-options"><a aria-hidden="true" tabindex="-1" href="#unifieduseremarkgfm-options"><span class="icon icon-link"></span></a><code>unified().use(remarkGfm[, options])</code></h3><div class="wrap-body">
<p>Plugin to support <a href="https://github.github.com/gfm/">GFM</a> (autolink literals, footnotes, strikethrough, tables,
tasklists).</p>
...
</div></div><div class="h5wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionssingletilde"><a aria-hidden="true" tabindex="-1" href="#optionssingletilde"><span class="icon icon-link"></span></a><code>options.singleTilde</code></h6><div class="wrap-body">
<p>Whether to parse strikethrough with a single tilde (<code>boolean</code>, default:
<code>true</code>).
Single tildes work on github.com, but are technically prohibited by the GFM
spec.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionstablecellpadding"><a aria-hidden="true" tabindex="-1" href="#optionstablecellpadding"><span class="icon icon-link"></span></a><code>options.tableCellPadding</code></h6><div class="wrap-body">
<p>Serialize tables with a space between delimiters (<code>|</code>) and cell content
(<code>boolean</code>, default: <code>true</code>).</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionstablepipealign"><a aria-hidden="true" tabindex="-1" href="#optionstablepipealign"><span class="icon icon-link"></span></a><code>options.tablePipeAlign</code></h6><div class="wrap-body">
<p>Serialize by aligning the delimiters (<code>|</code>) between table cells so that they all
align nicely and form a grid (<code>boolean</code>, default: <code>true</code>).</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsstringlength"><a aria-hidden="true" tabindex="-1" href="#optionsstringlength"><span class="icon icon-link"></span></a><code>options.stringLength</code></h6><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="example-singletilde"><a aria-hidden="true" tabindex="-1" href="#example-singletilde"><span class="icon icon-link"></span></a>Example: <code>singleTilde</code></h3><div class="wrap-body">
<p>To turn off support for parsing strikethrough with single tildes, pass
<code>singleTilde: false</code>:</p>
<pre class="language-js"><code class="language-js code-highlight"><span class="code-line"><span class="token comment">// …</span>
</span><span class="code-line">
</span><span class="code-line"><span class="token keyword">const</span> file <span class="token operator">=</span> <span class="token keyword control-flow">await</span> <span class="token function">unified</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</span><span class="code-line">  <span class="token punctuation">.</span><span class="token method function property-access">use</span><span class="token punctuation">(</span>remarkParse<span class="token punctuation">)</span>
</span><span class="code-line">  <span class="token punctuation">.</span><span class="token method function property-access">use</span><span class="token punctuation">(</span>remarkGfm<span class="token punctuation">,</span> <span class="token punctuation">{</span><span class="token literal-property property">singleTilde</span><span class="token operator">:</span> <span class="token boolean">false</span><span class="token punctuation">}</span><span class="token punctuation">)</span>
</span><span class="code-line">  <span class="token punctuation">.</span><span class="token method function property-access">use</span><span class="token punctuation">(</span>remarkRehype<span class="token punctuation">)</span>
</span><span class="code-line">  <span class="token punctuation">.</span><span class="token method function property-access">use</span><span class="token punctuation">(</span>rehypeStringify<span class="token punctuation">)</span>
</span><span class="code-line">  <span class="token punctuation">.</span><span class="token method function property-access">process</span><span class="token punctuation">(</span><span class="token string">'~one~ and ~~two~~'</span><span class="token punctuation">)</span>
</span><span class="code-line">
</span><span class="code-line"><span class="token console class-name">console</span><span class="token punctuation">.</span><span class="token method function property-access">log</span><span class="token punctuation">(</span><span class="token known-class-name class-name">String</span><span class="token punctuation">(</span>file<span class="token punctuation">)</span><span class="token punctuation">)</span>
</span></code></pre>
<p>Yields:</p>
<pre class="language-html"><code class="language-html code-highlight"><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>p</span><span class="token punctuation">></span></span>~one~ and <span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>del</span><span class="token punctuation">></span></span>two<span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>del</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>p</span><span class="token punctuation">></span></span>
</span></code></pre>
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="example-stringlength"><a aria-hidden="true" tabindex="-1" href="#example-stringlength"><span class="icon icon-link"></span></a>Example: <code>stringLength</code></h3><div class="wrap-body">
...
</span><span class="code-line">  <span class="token keyword">const</span> input <span class="token operator">=</span> <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">| Alpha | Bravo |
...
</span><span class="code-line">  <span class="token keyword">const</span> file <span class="token operator">=</span> <span class="token keyword control-flow">await</span> <span class="token function">remark</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</span><span class="code-line">    <span class="token punctuation">.</span><span class="token method function property-access">use</span><span class="token punctuation">(</span>remarkGfm<span class="token punctuation">)</span>
</span><span class="code-line">    <span class="token punctuation">.</span><span class="token method function property-access">process</span><span class="token punctuation">(</span>input<span class="token punctuation">)</span>
</span><span class="code-line">
</span><span class="code-line">  <span class="token console class-name">console</span><span class="token punctuation">.</span><span class="token method function property-access">log</span><span class="token punctuation">(</span><span class="token known-class-name class-name">String</span><span class="token punctuation">(</span>file<span class="token punctuation">)</span><span class="token punctuation">)</span>
</span><span class="code-line"><span class="token punctuation">}</span>
</span></code></pre>
<p>The above code shows how remark can be used to format markdown.
...
<pre class="language-diff"><code class="language-diff code-highlight"><span class="code-line"><span class="token coord">@@ -1,5 +1,6 @@</span>
</span><span class="code-line"><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">import {remark} from 'remark'
</span></span></span><span class="code-line"><span class="token unchanged"><span class="token line"></span><span class="token prefix unchanged"> </span><span class="token line">import remarkGfm from 'remark-gfm'
...
</span><span class="code-line">@@ -10,7 +11,7 @@ async function main() {
</span><span class="code-line"><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">| 👩‍❤️‍👩 | Delta |`
</span></span></span><span class="code-line"><span class="token unchanged"><span class="token line"></span></span>
</span><span class="code-line"><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">  const file = await remark()
</span></span></span><span class="code-line deleted"><span class="token unchanged"><span class="token line"></span></span><span class="token deleted-sign deleted"><span class="token prefix deleted">-</span><span class="token line">    .use(remarkGfm)
</span></span></span><span class="code-line inserted"><span class="token deleted-sign deleted"><span class="token line"></span></span><span class="token inserted-sign inserted"><span class="token prefix inserted">+</span><span class="token line">    .use(remarkGfm, {stringLength: stringWidth})
</span></span></span><span class="code-line"><span class="token inserted-sign inserted"><span class="token line"></span></span><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">    .process(input)
</span></span></span><span class="code-line"><span class="token unchanged"><span class="token line"></span></span>
</span><span class="code-line"><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">  console.log(String(file))
</span></span></span></code></pre>
...
<p>This plugin works with <code>remark-parse</code> version 10+ (<code>remark</code> version 14+).
The previous version (v2) worked with <code>remark-parse</code> version 9 (<code>remark</code>
version 13).
Earlier versions of <code>remark-parse</code> and <code>remark</code> had a <code>gfm</code> option that enabled
this functionality, which defaulted to true.</p>
...
<p>Use of <code>remark-gfm</code> does not involve <strong><a href="https://github.com/rehypejs/rehype">rehype</a></strong> (<strong><a href="https://github.com/syntax-tree/hast">hast</a></strong>) so there are
no openings for <a href="https://en.wikipedia.org/wiki/Cross-site_scripting">cross-site scripting (XSS)</a> attacks.</p>
...
— link references to commits, issues, PRs, and users</li>
<li><a href="https://github.com/remarkjs/remark-breaks"><code>remark-breaks</code></a>
— support breaks without needing spaces or escapes (enters to <code>&#x3C;br></code>)</li>
<li><a href="https://github.com/remarkjs/remark-frontmatter"><code>remark-frontmatter</code></a>
— support frontmatter (YAML, TOML, and more)</li>
<li><a href="https://github.com/remarkjs/remark-directive"><code>remark-directive</code></a>
— support directives</li>
<li><a href="https://github.com/remarkjs/remark-math"><code>remark-math</code></a>
— support math</li>
</ul>
