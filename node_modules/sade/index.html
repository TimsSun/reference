...
</script><a href="https://github.com/jaywcjlove/reference" class="" target="__blank"><svg viewBox="0 0 16 16" fill="currentColor" height="1em" width="1em"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a></div></div></nav><div class="wrap max-container"><header class="wrap-header h1wrap"><h1 id="sade-"><a aria-hidden="true" tabindex="-1" href="#sade-"><span class="icon icon-link"></span></a>sade <a href="https://travis-ci.org/lukeed/sade"><img src="https://travis-ci.org/lukeed/sade.svg?branch=master" alt="Build Status"></a></h1><div class="wrap-body">
<blockquote>
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="tips"><a aria-hidden="true" tabindex="-1" href="#tips"><span class="icon icon-link"></span></a>Tips</h2><div class="wrap-body">
<ul>
<li>
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="subcommands"><a aria-hidden="true" tabindex="-1" href="#subcommands"><span class="icon icon-link"></span></a>Subcommands</h2><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="single-command-mode"><a aria-hidden="true" tabindex="-1" href="#single-command-mode"><span class="icon icon-link"></span></a>Single Command Mode</h2><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="command-aliases"><a aria-hidden="true" tabindex="-1" href="#command-aliases"><span class="icon icon-link"></span></a>Command Aliases</h2><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="sadename-issingle"><a aria-hidden="true" tabindex="-1" href="#sadename-issingle"><span class="icon icon-link"></span></a>sade(name, isSingle)</h3><div class="wrap-body">
<p>Returns: <code>Program</code></p>
<p>Returns your chainable Sade instance, aka your <code>Program</code>.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="name"><a aria-hidden="true" tabindex="-1" href="#name"><span class="icon icon-link"></span></a>name</h4><div class="wrap-body">
<p>Type: <code>String</code><br>
Required: <code>true</code></p>
<p>The name of your <code>Program</code> / binary application.</p>
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="issingle"><a aria-hidden="true" tabindex="-1" href="#issingle"><span class="icon icon-link"></span></a>isSingle</h4><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progcommandusage-desc-opts"><a aria-hidden="true" tabindex="-1" href="#progcommandusage-desc-opts"><span class="icon icon-link"></span></a>prog.command(usage, desc, opts)</h3><div class="wrap-body">
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="usage-1"><a aria-hidden="true" tabindex="-1" href="#usage-1"><span class="icon icon-link"></span></a>usage</h4><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="desc"><a aria-hidden="true" tabindex="-1" href="#desc"><span class="icon icon-link"></span></a>desc</h4><div class="wrap-body">
<p>Type: <code>String</code><br>
Default: <code>''</code></p>
<p>The Command's description. The value is passed directly to <a href="#progdescribetext"><code>prog.describe</code></a>.</p>
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="opts"><a aria-hidden="true" tabindex="-1" href="#opts"><span class="icon icon-link"></span></a>opts</h4><div class="wrap-body">
<p>Type: <code>Object</code><br>
Default: <code>{}</code></p>
</div></div><div class="h4wrap-body"><div class="wrap"><div class="wrap-header h5wrap"><h5 id="optsalias"><a aria-hidden="true" tabindex="-1" href="#optsalias"><span class="icon icon-link"></span></a>opts.alias</h5><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h5wrap"><h5 id="optsdefault"><a aria-hidden="true" tabindex="-1" href="#optsdefault"><span class="icon icon-link"></span></a>opts.default</h5><div class="wrap-body">
...
</div></div></div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progdescribetext"><a aria-hidden="true" tabindex="-1" href="#progdescribetext"><span class="icon icon-link"></span></a>prog.describe(text)</h3><div class="wrap-body">
<p>Add a description to the current Command.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="text"><a aria-hidden="true" tabindex="-1" href="#text"><span class="icon icon-link"></span></a>text</h4><div class="wrap-body">
<p>Type: <code>String|Array</code></p>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progaliasnames"><a aria-hidden="true" tabindex="-1" href="#progaliasnames"><span class="icon icon-link"></span></a>prog.alias(...names)</h3><div class="wrap-body">
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="names"><a aria-hidden="true" tabindex="-1" href="#names"><span class="icon icon-link"></span></a>names</h4><div class="wrap-body">
<p>Type: <code>String</code></p>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progactionhandler"><a aria-hidden="true" tabindex="-1" href="#progactionhandler"><span class="icon icon-link"></span></a>prog.action(handler)</h3><div class="wrap-body">
<p>Attach a callback to the current Command.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="handler"><a aria-hidden="true" tabindex="-1" href="#handler"><span class="icon icon-link"></span></a>handler</h4><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progexamplestr"><a aria-hidden="true" tabindex="-1" href="#progexamplestr"><span class="icon icon-link"></span></a>prog.example(str)</h3><div class="wrap-body">
<p>Add an example for the current Command.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="str"><a aria-hidden="true" tabindex="-1" href="#str"><span class="icon icon-link"></span></a>str</h4><div class="wrap-body">
<p>Type: <code>String</code></p>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progoptionflags-desc-value"><a aria-hidden="true" tabindex="-1" href="#progoptionflags-desc-value"><span class="icon icon-link"></span></a>prog.option(flags, desc, value)</h3><div class="wrap-body">
<p>Add an Option to the current Command.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="flags"><a aria-hidden="true" tabindex="-1" href="#flags"><span class="icon icon-link"></span></a>flags</h4><div class="wrap-body">
<p>Type: <code>String</code></p>
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="desc-1"><a aria-hidden="true" tabindex="-1" href="#desc-1"><span class="icon icon-link"></span></a>desc</h4><div class="wrap-body">
<p>Type: <code>String</code></p>
<p>The description for the Option.</p>
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="value"><a aria-hidden="true" tabindex="-1" href="#value"><span class="icon icon-link"></span></a>value</h4><div class="wrap-body">
<p>Type: <code>String</code></p>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progversionstr"><a aria-hidden="true" tabindex="-1" href="#progversionstr"><span class="icon icon-link"></span></a>prog.version(str)</h3><div class="wrap-body">
<p>The <code>--version</code> and <code>-v</code> flags will automatically output the Program version.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="str-1"><a aria-hidden="true" tabindex="-1" href="#str-1"><span class="icon icon-link"></span></a>str</h4><div class="wrap-body">
<p>Type: <code>String</code><br>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="progparsearr-opts"><a aria-hidden="true" tabindex="-1" href="#progparsearr-opts"><span class="icon icon-link"></span></a>prog.parse(arr, opts)</h3><div class="wrap-body">
<p>Parse a set of CLI arguments.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="arr"><a aria-hidden="true" tabindex="-1" href="#arr"><span class="icon icon-link"></span></a>arr</h4><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="opts-1"><a aria-hidden="true" tabindex="-1" href="#opts-1"><span class="icon icon-link"></span></a>opts</h4><div class="wrap-body">
<p>Type: <code>Object</code><br>
Default: <code>{}</code></p>
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="optsunknown"><a aria-hidden="true" tabindex="-1" href="#optsunknown"><span class="icon icon-link"></span></a>opts.unknown</h4><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="optslazy"><a aria-hidden="true" tabindex="-1" href="#optslazy"><span class="icon icon-link"></span></a>opts.lazy</h4><div class="wrap-body">
<p>Type: <code>Boolean</code><br>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="proghelpcmd"><a aria-hidden="true" tabindex="-1" href="#proghelpcmd"><span class="icon icon-link"></span></a>prog.help(cmd)</h3><div class="wrap-body">
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="cmd"><a aria-hidden="true" tabindex="-1" href="#cmd"><span class="icon icon-link"></span></a>cmd</h4><div class="wrap-body">
<p>Type: <code>String</code><br>
