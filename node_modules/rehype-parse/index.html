...
</script><a href="https://github.com/jaywcjlove/reference" class="" target="__blank"><svg viewBox="0 0 16 16" fill="currentColor" height="1em" width="1em"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a></div></div></nav><div class="wrap max-container"><header class="wrap-header h1wrap"><h1 id="rehype-parse"><a aria-hidden="true" tabindex="-1" href="#rehype-parse"><span class="icon icon-link"></span></a>rehype-parse</h1><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="unifieduserehypeparse-options"><a aria-hidden="true" tabindex="-1" href="#unifieduserehypeparse-options"><span class="icon icon-link"></span></a><code>unified().use(rehypeParse[, options])</code></h3><div class="wrap-body">
...
</div></div><div class="h5wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsfragment"><a aria-hidden="true" tabindex="-1" href="#optionsfragment"><span class="icon icon-link"></span></a><code>options.fragment</code></h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsemitparseerrors"><a aria-hidden="true" tabindex="-1" href="#optionsemitparseerrors"><span class="icon icon-link"></span></a><code>options.emitParseErrors</code></h6><div class="wrap-body">
...
<!-- parse-error end -->
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsverbose"><a aria-hidden="true" tabindex="-1" href="#optionsverbose"><span class="icon icon-link"></span></a><code>options.verbose</code></h6><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="example-fragment-versus-document"><a aria-hidden="true" tabindex="-1" href="#example-fragment-versus-document"><span class="icon icon-link"></span></a>Example: fragment versus document</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="example-whitespace-around-and-inside-html"><a aria-hidden="true" tabindex="-1" href="#example-whitespace-around-and-inside-html"><span class="icon icon-link"></span></a>Example: whitespace around and inside <code>&#x3C;html></code></h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="example-parse-errors"><a aria-hidden="true" tabindex="-1" href="#example-parse-errors"><span class="icon icon-link"></span></a>Example: parse errors</h3><div class="wrap-body">
