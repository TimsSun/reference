...
</script><a href="https://github.com/jaywcjlove/reference" class="" target="__blank"><svg viewBox="0 0 16 16" fill="currentColor" height="1em" width="1em"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a></div></div></nav><div class="wrap"><div class="wrap-header h2wrap"><h2 id="feature-highlights"><a aria-hidden="true" tabindex="-1" href="#feature-highlights"><span class="icon icon-link"></span></a>Feature highlights</h2><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="intro"><a aria-hidden="true" tabindex="-1" href="#intro"><span class="icon icon-link"></span></a>Intro</h2><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="micromarkvalue-encoding-options"><a aria-hidden="true" tabindex="-1" href="#micromarkvalue-encoding-options"><span class="icon icon-link"></span></a><code>micromark(value[, encoding][, options])</code></h3><div class="wrap-body">
<p>Compile markdown to HTML.</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h5wrap"><h5 id="parameters"><a aria-hidden="true" tabindex="-1" href="#parameters"><span class="icon icon-link"></span></a>Parameters</h5><div class="wrap-body">
</div></div><div class="h5wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="value"><a aria-hidden="true" tabindex="-1" href="#value"><span class="icon icon-link"></span></a><code>value</code></h6><div class="wrap-body">
<p>Markdown to parse (<code>string</code> or <code>Buffer</code>).</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="encoding"><a aria-hidden="true" tabindex="-1" href="#encoding"><span class="icon icon-link"></span></a><code>encoding</code></h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsdefaultlineending"><a aria-hidden="true" tabindex="-1" href="#optionsdefaultlineending"><span class="icon icon-link"></span></a><code>options.defaultLineEnding</code></h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsallowdangeroushtml"><a aria-hidden="true" tabindex="-1" href="#optionsallowdangeroushtml"><span class="icon icon-link"></span></a><code>options.allowDangerousHtml</code></h6><div class="wrap-body">
<p>Whether to allow embedded HTML (<code>boolean</code>, default: <code>false</code>).
See <a href="#security">§ Security</a>.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsallowdangerousprotocol"><a aria-hidden="true" tabindex="-1" href="#optionsallowdangerousprotocol"><span class="icon icon-link"></span></a><code>options.allowDangerousProtocol</code></h6><div class="wrap-body">
...
See <a href="#security">§ Security</a>.</p>
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionsextensions"><a aria-hidden="true" tabindex="-1" href="#optionsextensions"><span class="icon icon-link"></span></a><code>options.extensions</code></h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="optionshtmlextensions"><a aria-hidden="true" tabindex="-1" href="#optionshtmlextensions"><span class="icon icon-link"></span></a><code>options.htmlExtensions</code></h6><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="streamoptions"><a aria-hidden="true" tabindex="-1" href="#streamoptions"><span class="icon icon-link"></span></a><code>stream(options?)</code></h3><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="extensions"><a aria-hidden="true" tabindex="-1" href="#extensions"><span class="icon icon-link"></span></a>Extensions</h2><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="list-of-extensions"><a aria-hidden="true" tabindex="-1" href="#list-of-extensions"><span class="icon icon-link"></span></a>List of extensions</h3><div class="wrap-body">
<ul>
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="community-extensions"><a aria-hidden="true" tabindex="-1" href="#community-extensions"><span class="icon icon-link"></span></a>Community extensions</h4><div class="wrap-body">
<ul>
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="syntaxextension"><a aria-hidden="true" tabindex="-1" href="#syntaxextension"><span class="icon icon-link"></span></a><code>SyntaxExtension</code></h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="htmlextension"><a aria-hidden="true" tabindex="-1" href="#htmlextension"><span class="icon icon-link"></span></a><code>HtmlExtension</code></h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="extending-markdown"><a aria-hidden="true" tabindex="-1" href="#extending-markdown"><span class="icon icon-link"></span></a>Extending markdown</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="creating-a-micromark-extension"><a aria-hidden="true" tabindex="-1" href="#creating-a-micromark-extension"><span class="icon icon-link"></span></a>Creating a micromark extension</h3><div class="wrap-body">
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="prerequisites"><a aria-hidden="true" tabindex="-1" href="#prerequisites"><span class="icon icon-link"></span></a>Prerequisites</h4><div class="wrap-body">
<ul>
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="extension-basics"><a aria-hidden="true" tabindex="-1" href="#extension-basics"><span class="icon icon-link"></span></a>Extension basics</h4><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="case-variables"><a aria-hidden="true" tabindex="-1" href="#case-variables"><span class="icon icon-link"></span></a>Case: variables</h4><div class="wrap-body">
...
</div></div><div class="h4wrap-body"><div class="wrap"><div class="wrap-header h5wrap"><h5 id="setup"><a aria-hidden="true" tabindex="-1" href="#setup"><span class="icon icon-link"></span></a>Setup</h5><div class="wrap-body">
...
works!</p>
</div></div></div><div class="wrap"><div class="wrap-header h5wrap"><h5 id="syntax-extension"><a aria-hidden="true" tabindex="-1" href="#syntax-extension"><span class="icon icon-link"></span></a>Syntax extension</h5><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h5wrap"><h5 id="html-extension"><a aria-hidden="true" tabindex="-1" href="#html-extension"><span class="icon icon-link"></span></a>HTML extension</h5><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h5wrap"><h5 id="further-exercises"><a aria-hidden="true" tabindex="-1" href="#further-exercises"><span class="icon icon-link"></span></a>Further exercises</h5><div class="wrap-body">
<p>It works!
We’re done!
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="case-turn-off-constructs"><a aria-hidden="true" tabindex="-1" href="#case-turn-off-constructs"><span class="icon icon-link"></span></a>Case: turn off constructs</h4><div class="wrap-body">
...
</div></div></div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="architecture"><a aria-hidden="true" tabindex="-1" href="#architecture"><span class="icon icon-link"></span></a>Architecture</h2><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="overview"><a aria-hidden="true" tabindex="-1" href="#overview"><span class="icon icon-link"></span></a>Overview</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="preprocess"><a aria-hidden="true" tabindex="-1" href="#preprocess"><span class="icon icon-link"></span></a>Preprocess</h3><div class="wrap-body">
...
file).</p>
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="parse"><a aria-hidden="true" tabindex="-1" href="#parse"><span class="icon icon-link"></span></a>Parse</h3><div class="wrap-body">
...
and we’re done!</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h4wrap"><h4 id="content-types"><a aria-hidden="true" tabindex="-1" href="#content-types"><span class="icon icon-link"></span></a>Content types</h4><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h4wrap"><h4 id="constructs"><a aria-hidden="true" tabindex="-1" href="#constructs"><span class="icon icon-link"></span></a>Constructs</h4><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="postprocess"><a aria-hidden="true" tabindex="-1" href="#postprocess"><span class="icon icon-link"></span></a>Postprocess</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="compile"><a aria-hidden="true" tabindex="-1" href="#compile"><span class="icon icon-link"></span></a>Compile</h3><div class="wrap-body">
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="github-flavored-markdown-gfm"><a aria-hidden="true" tabindex="-1" href="#github-flavored-markdown-gfm"><span class="icon icon-link"></span></a>GitHub flavored markdown (GFM)</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="math"><a aria-hidden="true" tabindex="-1" href="#math"><span class="icon icon-link"></span></a>Math</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="syntax-tree"><a aria-hidden="true" tabindex="-1" href="#syntax-tree"><span class="icon icon-link"></span></a>Syntax tree</h3><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="markdown"><a aria-hidden="true" tabindex="-1" href="#markdown"><span class="icon icon-link"></span></a>Markdown</h2><div class="wrap-body">
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="commonmark"><a aria-hidden="true" tabindex="-1" href="#commonmark"><span class="icon icon-link"></span></a>CommonMark</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="grammar"><a aria-hidden="true" tabindex="-1" href="#grammar"><span class="icon icon-link"></span></a>Grammar</h3><div class="wrap-body">
...
</div></div></div></div></div><div class="wrap"><div class="wrap-header h2wrap"><h2 id="project"><a aria-hidden="true" tabindex="-1" href="#project"><span class="icon icon-link"></span></a>Project</h2><div class="wrap-body">
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="comparison"><a aria-hidden="true" tabindex="-1" href="#comparison"><span class="icon icon-link"></span></a>Comparison</h3><div class="wrap-body">
...
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="micromark"><a aria-hidden="true" tabindex="-1" href="#micromark"><span class="icon icon-link"></span></a>micromark</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="remark"><a aria-hidden="true" tabindex="-1" href="#remark"><span class="icon icon-link"></span></a>remark</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="marked"><a aria-hidden="true" tabindex="-1" href="#marked"><span class="icon icon-link"></span></a>marked</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="markdown-it"><a aria-hidden="true" tabindex="-1" href="#markdown-it"><span class="icon icon-link"></span></a>markdown-it</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h6wrap"><h6 id="others"><a aria-hidden="true" tabindex="-1" href="#others"><span class="icon icon-link"></span></a>Others</h6><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="size--debug"><a aria-hidden="true" tabindex="-1" href="#size--debug"><span class="icon icon-link"></span></a>Size &#x26; debug</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="version"><a aria-hidden="true" tabindex="-1" href="#version"><span class="icon icon-link"></span></a>Version</h3><div class="wrap-body">
<p>micromark adheres to <a href="https://semver.org">semver</a> since 3.0.0.</p>
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="security"><a aria-hidden="true" tabindex="-1" href="#security"><span class="icon icon-link"></span></a>Security</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="contribute"><a aria-hidden="true" tabindex="-1" href="#contribute"><span class="icon icon-link"></span></a>Contribute</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="sponsor"><a aria-hidden="true" tabindex="-1" href="#sponsor"><span class="icon icon-link"></span></a>Sponsor</h3><div class="wrap-body">
...
</div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="origin-story"><a aria-hidden="true" tabindex="-1" href="#origin-story"><span class="icon icon-link"></span></a>Origin story</h3><div class="wrap-body">
