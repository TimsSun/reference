...
<span class="title">Quick Reference</span></a><div class="menu"><a href="https://github.com/jaywcjlove/reference/blob/main/node_modules/micromark-extension-gfm\readme.md" class="" target="__blank"><svg viewBox="0 0 36 36" fill="currentColor" height="1em" width="1em"><path d="m33 6.4-3.7-3.7a1.71 1.71 0 0 0-2.36 0L23.65 6H6a2 2 0 0 0-2 2v22a2 2 0 0 0 2 2h22a2 2 0 0 0 2-2V11.76l3-3a1.67 1.67 0 0 0 0-2.36ZM18.83 20.13l-4.19.93 1-4.15 9.55-9.57 3.23 3.23ZM29.5 9.43 26.27 6.2l1.85-1.85 3.23 3.23Z"></path><path fill="none" d="M0 0h36v36H0z"></path></svg><span>编辑</span></a><button id="darkMode" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="light" height="1em" width="1em">
...
</script><a href="https://github.com/jaywcjlove/reference" class="" target="__blank"><svg viewBox="0 0 16 16" fill="currentColor" height="1em" width="1em"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a></div></div></nav><div class="wrap max-container"><header class="wrap-header h1wrap"><h1 id="micromark-extension-gfm"><a aria-hidden="true" tabindex="-1" href="#micromark-extension-gfm"><span class="icon icon-link"></span></a>micromark-extension-gfm</h1><div class="wrap-body">
<p><a href="https://github.com/micromark/micromark-extension-gfm/actions"><img src="https://github.com/micromark/micromark-extension-gfm/workflows/main/badge.svg" alt="Build"></a>
<a href="https://codecov.io/github/micromark/micromark-extension-gfm"><img src="https://img.shields.io/codecov/c/github/micromark/micromark-extension-gfm.svg" alt="Coverage"></a>
<a href="https://www.npmjs.com/package/micromark-extension-gfm"><img src="https://img.shields.io/npm/dm/micromark-extension-gfm.svg" alt="Downloads"></a>
<a href="https://bundlephobia.com/result?p=micromark-extension-gfm"><img src="https://img.shields.io/bundlephobia/minzip/micromark-extension-gfm.svg" alt="Size"></a>
...
<p><strong><a href="https://github.com/micromark/micromark">micromark</a></strong> extension to support GitHub flavored markdown (<a href="https://github.github.com/gfm/">GFM</a>).</p>
...
<li><a href="#api">API</a>
<ul>
<li><a href="#gfmoptions"><code>gfm(options?)</code></a></li>
<li><a href="#gfmhtmlhtmloptions"><code>gfmHtml(htmlOptions?)</code></a></li>
</ul>
</li>
...
<p>This package is a micromark extension to add support for all GFM features:
autolink literals, footnotes, strikethrough, tables, tagfilter, and tasklists.</p>
...
<p>You probably should use this package if you use micromark and want to enable
GFM.
When working with syntax trees, you’d want to combine this package with
<a href="https://github.com/syntax-tree/mdast-util-gfm"><code>mdast-util-gfm</code></a>.</p>
<p>You can also use the underlying features separately:</p>
<ul>
...
<pre class="language-sh"><code class="language-sh code-highlight"><span class="code-line"><span class="token function">npm</span> <span class="token function">install</span> micromark-extension-gfm
</span></code></pre>
<p>In Deno with <a href="https://www.skypack.dev">Skypack</a>:</p>
<pre class="language-js"><code class="language-js code-highlight"><span class="code-line"><span class="token keyword module">import</span> <span class="token imports"><span class="token punctuation">{</span>gfm<span class="token punctuation">,</span> gfmHtml<span class="token punctuation">}</span></span> <span class="token keyword module">from</span> <span class="token string">'https://cdn.skypack.dev/micromark-extension-gfm@2?dts'</span>
</span></code></pre>
...
</span></span></span><span class="code-line"><span class="token script"><span class="token language-javascript">  <span class="token keyword module">import</span> <span class="token imports"><span class="token punctuation">{</span>gfm<span class="token punctuation">,</span> gfmHtml<span class="token punctuation">}</span></span> <span class="token keyword module">from</span> <span class="token string">'https://cdn.skypack.dev/micromark-extension-gfm@2?min'</span>
...
</span><span class="code-line">  <span class="token literal-property property">allowDangerousHtml</span><span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span>
...
</span><span class="code-line"><span class="token entity named-entity" title="<">&#x26;lt;</span>plaintext>
...
</span><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>li</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>input</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>checkbox<span class="token punctuation">"</span></span> <span class="token attr-name">disabled</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span> to do<span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>li</span><span class="token punctuation">></span></span>
</span><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>li</span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>input</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>checkbox<span class="token punctuation">"</span></span> <span class="token attr-name">disabled</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token punctuation">"</span></span> <span class="token attr-name">checked</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span> done<span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>li</span><span class="token punctuation">></span></span>
</span><span class="code-line"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;/</span>ul</span><span class="token punctuation">></span></span>
...
<p>This package exports the following identifiers: <code>gfm</code>, <code>gfmHtml</code>.
There is no default export.</p>
<p>This extensions supports the endorsed <a href="https://nodejs.org/api/packages.html#packages_resolving_user_conditions"><code>development</code> condition</a>.
...
</div></div><div class="h2wrap-body"><div class="wrap"><div class="wrap-header h3wrap"><h3 id="gfmoptions"><a aria-hidden="true" tabindex="-1" href="#gfmoptions"><span class="icon icon-link"></span></a><code>gfm(options?)</code></h3><div class="wrap-body">
<p>A function that can be called to get an extension for micromark to parse GFM
(can be passed in <code>extensions</code>).</p>
...
Passed as <a href="https://github.com/micromark/micromark-extension-gfm-strikethrough#optionssingletilde"><code>singleTilde</code></a> in
...
</div></div></div></div></div></div></div><div class="wrap"><div class="wrap-header h3wrap"><h3 id="gfmhtmlhtmloptions"><a aria-hidden="true" tabindex="-1" href="#gfmhtmlhtmloptions"><span class="icon icon-link"></span></a><code>gfmHtml(htmlOptions?)</code></h3><div class="wrap-body">
<p>A function that can be called to get an extension to compile GFM to HTML (can be
passed in <code>htmlExtensions</code>).</p>
</div></div><div class="h3wrap-body"><div class="wrap"><div class="wrap-header h5wrap"><h5 id="htmloptions"><a aria-hidden="true" tabindex="-1" href="#htmloptions"><span class="icon icon-link"></span></a><code>htmlOptions</code></h5><div class="wrap-body">
<p>Configuration (optional).</p>
</div></div><div class="h5wrap-body"><div class="wrap"><div class="wrap-header h6wrap"><h6 id="htmloptionsclobberprefix"><a aria-hidden="true" tabindex="-1" href="#htmloptionsclobberprefix"><span class="icon icon-link"></span></a><code>htmlOptions.clobberPrefix</code></h6><div class="wrap-body">
...
Passed as <a href="https://github.com/micromark/micromark-extension-gfm-footnote#htmloptionsclobberprefix"><code>clobberPrefix</code></a> in
<a href="https://github.com/micromark/micromark-extension-gfm-footnote"><code>micromark-extension-gfm-footnote</code></a>.</p>
...
Passed as <a href="https://github.com/micromark/micromark-extension-gfm-footnote#htmloptionslabel"><code>label</code></a> in
<a href="https://github.com/micromark/micromark-extension-gfm-footnote"><code>micromark-extension-gfm-footnote</code></a>.</p>
...
Passed as <a href="https://github.com/micromark/micromark-extension-gfm-footnote#htmloptionsbacklabel"><code>backLabel</code></a> in
<a href="https://github.com/micromark/micromark-extension-gfm-footnote"><code>micromark-extension-gfm-footnote</code></a>.</p>
...
It exports additional <code>Options</code> and <code>HtmlOptions</code> types that model their
...
<p>This package is safe by default.</p>
